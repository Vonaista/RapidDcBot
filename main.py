...
def button():
	BUTTON=[[InlineKeyboardButton(text=" Sahibim ",url="t.me/jacquel1n")]]
	BUTTON+=[[InlineKeyboardButton(text="  Kodları  ",url="https://github.com/Wenxtry/jacquel1nbot")]]
